...
const RootWrapper = () => {
  const [active, setActive] = useState(
    localStorage.getItem("tab") ? Number(localStorage.getItem("tab")) : 0,
  );
      ...
      <div className="global-frame-layout">
        <div className="frame-part">
          <div className="macos-buttons">
            <span
              className="macos-buttons_items"
              onClick={() => (window as any).api.send("close")}
            ></span>
            <span
              className="macos-buttons_items"
              onClick={() => (window as any).api.send("minimize")}
            ></span>
          ...
          <div className="screens-tabs">
            <div className="screens-tabs__wrapper">
              <div
                ...
                style={{
                  color: active === 0 ? "#211e1e" : "rgb(33 30 30 / 63%)",
              ...
              <div
                className="task-manager tabs-item"
                style={{
                  color: active === 1 ? "#211e1e" : "rgb(33 30 30 / 63%)",
              ...
              <div
                className="grey-space"
                style={{ transform: `translate(${active * 100}%, 0px)` }}
              ></div>
            </div>
          </div>

          <div
            className="toolbar-drag-button"
            onClick={() => (window as any).api.send("settings-button")}
          >
            <svg
              width={20}
              height={20}
