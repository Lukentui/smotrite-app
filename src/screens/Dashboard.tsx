...
export default () => {
  ...
  return <Grid numItems={1} numItemsSm={2} numItemsLg={2} className="gap-6" style={{
    padding: '30px',
    paddingTop: 0,
    paddingBottom: 0,
    marginTop: 7,
                ...
                .map((widget, index) =>
                  <Draggable key={widget} draggableId={widget} index={index} isDragDisabled={false}>
                    {(draggableProvided, draggableSnapshot) => (
                      ...
                      >
                        <div style={{ height: "1.5rem" }} className={index === 0 && 'first-right-side-buffer'} /> 
                        {
                          React.createElement(WidgetsComponents[widget as keyof typeof WidgetsComponents], {
                            updatesHeap: updatesHeap.current,
                            layoutUpdate: layoutUpdate,
                        ...
                        }
                        {
                          ...
                          <div style={{ height: "1.5rem" }} className={'last-right-side-buffer'} /> 
                        }
                      </div>
                    )}
                  </Draggable>)
